...
class MyNotificationScreen extends StatefulWidget {
  ...
  @override
  State<MyNotificationScreen> createState() => MyNotificationScreenState();
}

class MyNotificationScreenState extends State<MyNotificationScreen> {
  @override
  void iniState() {
    super.initState();
   ...
   //  Mendengarkan pesan saat aplikasi aktif 
    FirebaseMessaging.onMessage.listen((RemoteMessage message) { 
      ...
      if (notification != null && android != null) { 
        var show = FlutterLocalNotificationsPlugin().show( 
